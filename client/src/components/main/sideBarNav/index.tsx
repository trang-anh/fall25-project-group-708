...
const SideBarNav = () => {
  ...
  useEffect(() => {
    if (location.pathname.startsWith('/match-discovery') || location.pathname.startsWith('/match')) {
    ...
    <div id='sideBarNav' className='sideBarNav'>
      ...
      <div
        ...
        style={{
          cursor: 'pointer',
          backgroundColor:
            location.pathname.startsWith('/match-discovery') || location.pathname.startsWith('/match')
