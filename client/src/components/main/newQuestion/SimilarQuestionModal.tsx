    ...
    <>
      ...
      <div className='modal_container'>
        <div className='modal_header'>
          ...
          <button className='modal_close_btn' onClick={onClose} aria-label='Close'>
            ×
          </button>
        </div>
        ...
        <div className='modal_body'>
          <p className='modal_message'>
            We found{' '}
            <strong>
              {suggestionCount} similar question{suggestionCount > 1 ? 's' : ''}
            </strong>{' '}
        ...
        <div className='modal_footer'>
          <button className='modal_btn modal_btn_secondary' onClick={onClose}>
            Cancel
          </button>
          <button className='modal_btn modal_btn_primary' onClick={onReview}>
